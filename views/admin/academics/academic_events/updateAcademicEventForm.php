<form name="frm-update-academic-event" class="form-horizontal form-label-left" onsubmit="academicEventController.manageAcademicEvent.saveUpdateAcademicEvent(this); return false;">
	<div class="row ">
		<div class="col-lg-12">
			<div class="row">
				<div class="col-lg-5">
