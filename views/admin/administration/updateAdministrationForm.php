			...
			<div class="row">
				...
				<div class="col-lg-7">
					<div class="form-group">
						...
						<input type="text" value="<?php echo $administration["data"]["firstname"];?>" maxlength="100" class="form-control" name="txt_firstname" placeholder="Enter first name&hellip;" required />
					</div>
					<div class="form-group">
						<label>Middle name:*</label>
						<input type="text" value="<?php echo $administration["data"]["middlename"];?>" maxlength="100" class="form-control" name="txt_middlename" placeholder="Enter middle name&hellip;" required />
					</div>
					<div class="form-group">
						<label>Last name:*</label>
						<input type="text" value="<?php echo $administration["data"]["lastname"];?>" maxlength="100" class="form-control" name="txt_lastname" placeholder="Enter last name&hellip;" required />
					</div>
					<div class="form-group">
						...
						<select name="txt_department" class="form-control" required>
							...
							<?php foreach($departments as $department):?>
								<option value="<?php echo $department["data"]["department_id"];?>" <?php if($administration["data"]["department_id"] == $department["data"]["department_id"]){echo "selected";};?>><?php echo $department["data"]["name"];?></option>
							<?php endforeach;?>
						</select>
					</div>
					<div class="form-group">
						...
						<select name="txt_position" class="form-control" required>
							...
							<?php foreach($positions as $position):?>
								<option value="<?php echo $position["data"]["position_id"];?>" <?php if($administration["data"]["position_id"] == $position["data"]["position_id"]){echo "selected";};?>><?php echo $position["data"]["name"];?></option>
							<?php endforeach;?>
						</select>
					</div>
				</div>
