<form name="frm_add_alumnus" onsubmit="alumniController.saveNewAlumni(this); return false;">
	<div class="row">
		<div class="col-lg-12">
			<div class="row">
				<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						...
						<input type="text" maxlength="100" class="form-control" name="txt_venue_graduated" placeholder="Enter venue graduated&hellip;" required />
					</div>
				</div>
				<div class="col-lg-6">
					<div class="form-group">
