<form name="frm_add_bids_and_awards" class="form-horizontal form-label-left" onsubmit="citizenCharterController.manageCitizenCharter.saveNewCitizenCharter(this); return false;">
	<div class="row " >
		<div class="col-lg-5 ">
			<div class="row">
				<div class="col-lg-12">
